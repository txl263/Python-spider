...
class JobSpider:
    def __int__(self):
        ...
        driver.find_element_by_xpath("//input[@id='kwdselectid']").send_keys("软件测试工程师")
    ...
    def get_end_page(self):
        self.end_page = int(self.dr.find_element_by_xpath('.totalNum').text)
        print (self.end_page)
